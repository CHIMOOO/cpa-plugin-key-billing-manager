...
func TestManagementRegistrationExposesOnlyCurrentEndpoints(t *testing.T) {
	...
	for _, value := range []string{
		...
		"POST /turn-state/templates/discard",
		"GET /turn-state/runner", "PUT /turn-state/runner", "POST /turn-state/runner/tick",
		...
		"POST /turn-state/cooldowns/clear", "POST /turn-state/self-test", "GET /persistence",
		"GET /turn-state/journal", "PUT /turn-state/journal", "DELETE /turn-state/journal",
